...
import TransactionSummaryPanel from "./transactionBuilder/TransactionSummaryPanel";
      ...
      case 0:
        return (
          <Grid container spacing={2}>
            <Grid
              size={{ xs: 12, md: isSummaryExpanded ? 12 : 8 }}
            ...
            <Grid
              size={{ xs: 12, md: isSummaryExpanded ? 12 : 4 }}
              sx={{
