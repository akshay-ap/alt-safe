    ...
    <Grid justifyContent={"flex-start"} alignItems={"flex-start"} container size={12}>
      ...
      {!selectedGroup && (
        <Grid justifyContent={"flex-start"} alignItems={"flex-start"} size={12} container spacing={2}>
          <Grid justifyContent={"flex-start"} alignItems={"flex-start"} size={10}>
            <TextField
              value={searchQuery}
      ...
      {!selectedGroup &&
        filteredGroups.map(([group, { icon, disabled }]) => (
          <Grid size={{ xs: 12, sm: 6, md: 4 }} p={0} m={0} key={group}>
            <Card
              sx={{
      ...
      {selectedGroup &&
        combinedTransactionTypes[selectedGroup]?.types.map((action) => (
          <Grid justifyContent={"flex-start"} alignItems={"flex-start"} size={{ xs: 12, sm: 6, md: 4 }} key={action}>
